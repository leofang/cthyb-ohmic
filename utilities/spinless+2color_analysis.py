...
N_TAU = 1500    # number of tau-points; must be large enough for the lowest temperature (set to at least 5*BETA*U)
N_ORBITALS = 1
      ...
      parameters.append(
             {
               ...
               'N_MEAS'                     : 10,      
               'N_ORBITALS'                 : 1,  
               'BASENAME'                   : "hyb.param_Mu_%.1f_BETA%.3f"%(Mu,1/t), # base name of the h5 output file
               'MAX_TIME'                   : 720,                          
               'VERBOSE'                    : 0,                            
               'TEXT_OUTPUT'                : 1,                                
               'N_ENV' 			    : 2,
...
#
#        # condor submit file
#        f.write("Initialdir = /home/yf30/cthyb-ohmic-color/test_spinless+2color/" + output_path + "\n")
...
#  
        ...
        ar=archive(output_path + parms['BASENAME']+'.out.h5', 'r')
