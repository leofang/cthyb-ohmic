...
#Tvalues  = W/np.array([50., 75., 100.])[::-1] # the values here are dimensionless (=beta*t)
...
output_dir = "20160813_semicircular_sigma_%i_lead_%i_orb_V_%.3f_U_%.3f_MAX_TIME_%.1f_hrs"%(N_ENV, N_ORBITALS, (V[0] if N_ENV is 1 else sqrt(V[0]**2+V[1]**2)), U, MAX_TIME/3600.)
