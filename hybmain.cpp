...
//Leo: Things related to building a Python module are disabled for the moment!
...
{
//#ifdef ALPS_HAVE_MPI
//  //std::cout << "ALPS has MPI!\nYeah!\n";
//#endif
//#ifdef BUILD_PYTHON_MODULE
//  std::cout << "Build Python module!\n";
//#endif
...
//#endif
      ...
      { //on any slave: send back results to master.
        collect_results(s);
      }
      c.barrier();
#else
